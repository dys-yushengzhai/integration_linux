...
# @torch.jit.script     #Scripting a function or nn.Module will inspect the source code

def graph_coarsen(row: torch.Tensor, col: torch.Tensor,
                    weight: Optional[torch.Tensor] = None,
                    num_nodes: Optional[int] = None) -> torch.Tensor:
    """Graph coarsen algorithm  (Heavg edge matching).
    ...
    return torch.ops.qgraph.coarsen(rowptr, col, weight)